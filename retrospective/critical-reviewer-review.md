# Post-Release Review - Critical Reviewer

## 1. Role Context
- Official scope: own Critical Reviewer decisions in the phase-one build and release path.
...
Role-specific focus for Critical Reviewer: review depth, blind spots, escalation quality
