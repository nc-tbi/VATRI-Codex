# Post-Release Review - Test Manager

## 1. Role Context
- Official scope: own Test Manager decisions in the phase-one build and release path.
...
Role-specific focus for Test Manager: regression sufficiency, prioritization, scenario detection
