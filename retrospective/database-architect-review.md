# Post-Release Review - Database Architect

## 1. Role Context
- Official scope: own Database Architect decisions in the phase-one build and release path.
...
Role-specific focus for Database Architect: schema safety, query resilience, migration validation
