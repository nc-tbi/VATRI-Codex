# Post-Release Review - Code Builder

## 1. Role Context
- Official scope: own Code Builder decisions in the phase-one build and release path.
...
Role-specific focus for Code Builder: implementation correctness, contract enforcement, defensive coding
