# Post-Release Review - DevOps

## 1. Role Context
- Official scope: own DevOps decisions in the phase-one build and release path.
...
Role-specific focus for DevOps: environment parity, deployment safety, CI gate strength
