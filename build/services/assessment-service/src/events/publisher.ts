...
export class AssessmentEventPublisher {
  ...
  // Phase 3 (design/03-phase-3-contract-freeze.md §7.3): sole publisher of tax-core.filing.assessed.
  // Payload frozen at v1.1.0 — all fields required.
  async publishAssessed(
    assessment: StagedAssessment & { assessment_id: string },
    traceId: string,
  ): Promise<void> {
    await this.send(
