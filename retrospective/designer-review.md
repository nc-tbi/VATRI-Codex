# Post-Release Review - Designer

## 1. Role Context
- Official scope: own Designer decisions in the phase-one build and release path.
...
Role-specific focus for Designer: design-to-implementation drift, component consistency
