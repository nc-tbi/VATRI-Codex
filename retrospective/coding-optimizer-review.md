# Post-Release Review - Coding Optimizer

## 1. Role Context
- Official scope: own Coding Optimizer decisions in the phase-one build and release path.
...
Role-specific focus for Coding Optimizer: maintainability, performance, missed optimization opportunities
