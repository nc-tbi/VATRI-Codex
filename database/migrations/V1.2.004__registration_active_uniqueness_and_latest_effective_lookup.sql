-- V1.2.004__registration_active_uniqueness_and_latest_effective_lookup.sql
-- Enforces one active registration per taxpayer and optimizes latest-effective selection.
