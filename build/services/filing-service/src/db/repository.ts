  ...
  async saveFiling(
    ...
    const rows = await this.sql`
      INSERT INTO filing.filings (
        ...
        rubrik_a_goods, rubrik_a_services,
        rubrik_b_goods_reportable, rubrik_b_goods_non_reportable,
        rubrik_b_services, rubrik_c,
        reimbursement_oil_and_bottled_gas_duty, reimbursement_electricity_duty,
